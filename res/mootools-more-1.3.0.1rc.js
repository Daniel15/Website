...
// Load this file's selection again by visiting: http://mootools.net/more-rc/88d22bdec11b52a418ebcddb38c17b63 
// Or build this file again with packager using: packager build More/More More/Date.Extras More/Request.JSONP More/Tips
/*
---
copyrights:
...
...
*/
MooTools.More={version:"1.3.0.1rc1",build:"361dd6c3755b66898e9e0ee5d55c343188b619b7"};Object.extend({getFromPath:function(d,c){var e=c.split(".");for(var b=0,a=e.length;
b<a;b++){if(d.hasOwnProperty(e[b])){d=d[e[b]];}else{return null;}}return d;},cleanValues:function(a,b){if(!b){b=function(c){return c!=null;};}for(key in a){if(!b(a[key])){delete a[key];
}}return a;},erase:function(a,b){if(a.hasOwnProperty(b)){delete a[b];}return a;},run:function(b){var a=Array.slice(arguments,1);for(key in b){if(typeOf(b[key])=="function"){b[key].apply(b,a);
}}return b;}});(function(){var b=null,a={},e={};var d=function(g){if(instanceOf(g,f.Set)){return g;}else{return a[g];}};var f=this.Locale={define:function(g,k,i,j){var h;
...
if(!g){g={};}if(h){if(typeOf(h)=="object"){g=Object.merge(g,h);}else{g[h]=i;}}this.sets[j]=g;return this;},get:function(r,k,q){var p=Object.getFromPath(this.sets,r);
...
var b=f.getDay();var c=Date.parseDay(e[2],true);var a=c-b;if(c<=b){a+=7;}if(e[1]=="last"){a-=7;}return f.set("date",f.getDate()+a);}});Request.JSONP=new Class({Implements:[Chain,Events,Options],options:{onRequest:function(a){if(this.options.log&&window.console&&console.log){console.log("JSONP retrieving script with url:"+a);
