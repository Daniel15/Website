...
<?php if (Daniel15Blog::$enableCompression) : ?>
	<link rel="stylesheet" href="/res/<?php echo Daniel15Blog::$siteData->latestCSS ?>" type="text/css" id="default-stylesheet" />
	<link rel="stylesheet" href="/res/<?php echo Daniel15Blog::$siteData->latestBlogCSS ?>" type="text/css" />
<?php else : ?>
