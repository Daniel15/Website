<?php
// Note: Copied from modules/pagination/views/pagination/floating.php and modified to use <li> tags
...
<ul class="pagination">
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php if ($number === $current_page): ?>
			<li class="active"><strong><?php echo $content ?></strong>
		<?php else: ?>
			<li><a href="<?php echo HTML::chars($page->url($number)) ?>"><?php echo $content ?></a>
		<?php endif ?></li>
