...
-- -----------------------------------------------------
-- Table `daniel15_new`.`elmah_error`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `daniel15_new`.`elmah_error` (
...
CREATE PROCEDURE `daniel15_new`.`elmah_GetErrorXml` (
  IN Id CHAR(36),
  IN App VARCHAR(60)
)
NOT DETERMINISTIC
...
CREATE PROCEDURE `daniel15_new`.`elmah_GetErrorsXml` (
  IN App VARCHAR(60),
  IN PageIndex INT(10),
  IN PageSize INT(10),
...
CREATE PROCEDURE `daniel15_new`.`elmah_LogError` (
    IN ErrorId CHAR(36), 
